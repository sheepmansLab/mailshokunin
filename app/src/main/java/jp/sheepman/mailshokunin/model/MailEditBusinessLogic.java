...
public class MailEditBusinessLogic extends BaseModel {
    ...
    public F003LayoutForm selectLayout(Context context, int layout_id){
        F003LayoutForm form = new F003LayoutForm();
    ...
    public List<F003LayoutItemForm> selectLayoutItems(Context context, int layout_id){

        List<String> params = new ArrayList<>();
        params.add(String.valueOf(layout_id));

        List<F003LayoutItemForm> list = new ArrayList<>();
        DatabaseUtil util = new DatabaseUtil(context);
        try {
            util.open();
            ...
            for (BaseEntity e : layouts) {
                ...
                F003LayoutItemForm form = new F003LayoutItemForm();
    ...
    public F003LayoutItemForm selectObjectTypeById(Context context, int object_id){
        F003LayoutItemForm form = new F003LayoutItemForm();
        DatabaseUtil util = new DatabaseUtil(context);
        List<String> params = new ArrayList<>();
        try {
